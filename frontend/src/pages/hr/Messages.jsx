...
const HrMessages = () => {
  ...
  // HR's Employee id from signin response
  useEffect(() => {
    if (user?.employeeId) {
  ...
  useEffect(() => {
    ...
    const fetchThread = async () => {
      ...
      try {
        ...
        console.error("Error fetching HR thread:", err);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      console.error("Error sending HR reply:", err);
      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            >
              Reply to messages from employees and managers.
            </p>
          </div>
        </div>
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      console.error("Error marking HR messages seen:", err);
                    }
                  }}
