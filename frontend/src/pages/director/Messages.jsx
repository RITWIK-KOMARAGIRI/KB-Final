...
const DirectorMessages = () => {
  ...
  // Director's Employee id from signin response
  useEffect(() => {
    if (user?.employeeId) {
  ...
  const loadContacts = useCallback(async () => {
    try {
      ...
      console.error("Error fetching Director contacts:", err);
    }
  ...
  useEffect(() => {
    ...
    const fetchThread = async () => {
      ...
      try {
        ...
        console.error("Error fetching Director thread:", err);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      console.error("Error sending Director reply:", err);
      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            >
              View and respond to messages from across the company.
            </p>
          </div>
        </div>
